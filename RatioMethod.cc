...
int main(){
  ...
  for (int i(0); i < (N_Pseudo_Exp); i++){                      // Loop over number of pseudo exp
    ...
    TH1D* h1 = (TH1D*)file -> Get(name1.c_str());   // Gets the pseudo wiggle plot
    TH1D* h2 = (TH1D*)file -> Get(name2.c_str());   // Gets the pseudo wiggle plot
    TH1D* h3 = (TH1D*)file -> Get(name3.c_str());   // Gets the pseudo wiggle plot
    TH1D* h4 = (TH1D*)file -> Get(name4.c_str());   // Gets the pseudo wiggle plot
